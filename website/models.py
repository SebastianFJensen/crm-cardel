...
class Record(models.Model):
    ...
    Bebyggelseprocent = models.DecimalField(max_digits=3, decimal_places=0, blank=True, null=True)
    arealbm2 = models.DecimalField(max_digits=12, decimal_places=0, blank=True, null=True)
    Byggemeterp = models.DecimalField(max_digits=12, decimal_places=0, blank=True, null=True)
    Salg_sum = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
